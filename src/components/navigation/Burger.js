...
const Burger = (props) => {
  ...
  return (
    <>
      ...
      <NavMenu isLoggedIn={props.isLoggedIn} history={props.history} menuOpen={menuOpen} setOpen={setOpen} getCartItemCount={props.getCartItemCount} logoutUser={props.logoutUser} />
    </>
  );
};
